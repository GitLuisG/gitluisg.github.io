  ...
  obtenerPantalla(name) {
    switch (name) {
      ...
      case "Zona de Juegos":
        ...
        case "Articulos":
          return  getArticle(
            ["Actualizacion 0.0.0.3"],
            [
              'Agregamos al curriculum Nueva experiencia laboral en grupoprotec',
              'Agregamos las secciones Zona de juegos y Articulos'
            ],2
          )+getArticle(
            ["Actualizacion 0.0.0.2"],
            [
              'Agregaron Witgets al Tablero',
              'Se Agregaron Imagenes extraidas desde el proyecto.'
            ],1
          )+getArticle(
            ["Actualizacion 0.0.0.1"],
            [
              'Incorporacion de la seccion de Tablero',
              'Incorporacion de la seccion de Proyecto',
              'Incorporacion de la seccion Sobre Mi'
            ],0
          );
          break;
        ...
        return (
          ...
          post([
            ...
            [
              ...
              "http://www.grupoprotec.com.mx/wp-content/uploads/2022/06/LOGO-light.svg",
              "Grupo Protec",
              "04:24 A.M.",
              "Empresa de seguridad con un alto nivel de especializacion en la rama de la seguridad con 32 años de experiencia." +
              postGaleria([
                Assets + "img/wa_grupoprotec.png",
                Assets + "img/GUARDIAS-DE-SEGURIDAD.png",
                Assets + "img/GUARDIAS-DE-SEGURIDAD.png",
                Assets + "img/GUARDIAS-DE-SEGURIDAD.png",
                Assets + "img/GUARDIAS-DE-SEGURIDAD.png",
              ], "dark", "200"),
